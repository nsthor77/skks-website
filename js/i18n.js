...
(function() {
  ...
  const TRANSLATIONS = {
    ...
    students: {
      ...
      fldNationalId: { en: 'National ID / Passport', th: 'เลขบัตรประชาชน / Passport' },
    ...
    parentBills: {
      portal: { en: 'Parent Portal', th: 'พอร์ทัลผู้ปกครอง' },
      home: { en: '← Home', th: '← หน้าหลัก' },
      signOut: { en: 'Sign Out', th: 'ออกจากระบบ' },
      title: { en: '📄 Bills & Payments', th: '📄 บิลและการชำระเงิน' },
      subtitle: { en: 'Outstanding bills and payment history', th: 'รายการบิลค้างชำระและประวัติการจ่ายเงิน' },
      statUnpaid: { en: 'Unpaid bills', th: 'บิลค้างชำระ' },
      statPending: { en: 'Pending review', th: 'รอตรวจสอบ' },
      statTotalDue: { en: 'Total due', th: 'ยอดค้างชำระทั้งหมด' },
      secToPay: { en: '⏰ Bills to pay', th: '⏰ บิลที่ต้องชำระ' },
      secPaid: { en: '✅ Paid', th: '✅ ชำระแล้ว' },
      emptyTitle: { en: 'No bills yet', th: 'ยังไม่มีบิล' },
      emptyDesc: { en: 'Bills issued by the school will appear here', th: 'เมื่อโรงเรียนออกบิลให้ จะปรากฏที่นี่' },
      noUnpaid: { en: 'No outstanding bills 🎉', th: 'ไม่มีบิลค้างชำระ 🎉' },
      noPaid: { en: 'No paid items yet', th: 'ยังไม่มีรายการที่ชำระแล้ว' },
      stUnpaid: { en: 'Unpaid', th: 'ค้างชำระ' },
      stPending: { en: 'Pending', th: 'รอตรวจ' },
      stOverdue: { en: 'Overdue', th: 'เลยกำหนด' },
      stPaid: { en: '✅ Paid', th: '✅ ชำระแล้ว' },
      due: { en: 'Due', th: 'กำหนดชำระ' },
      paidOn: { en: 'Paid on', th: 'ชำระเมื่อ' },
      btnPay: { en: '💳 Pay', th: '💳 ชำระเงิน' },
      waitingReview: { en: '⏳ Awaiting review', th: '⏳ รอตรวจสอบ' },
      modalPay: { en: '💳 Make Payment', th: '💳 ชำระเงิน' },
      uploadSlip: { en: '📤 Upload Slip', th: '📤 อัปโหลดสลิป' },
      uploadHint: { en: 'After transferring, upload your slip here — staff will verify and issue a receipt', th: 'หลังโอนเงินแล้ว อัปโหลดสลิปที่นี่ — ครูจะตรวจสอบและส่งใบเสร็จกลับให้' },
      clickUpload: { en: 'Click to upload slip', th: 'คลิกเพื่ออัปโหลดสลิป' },
      fileLimit: { en: 'JPG, PNG — max 5MB', th: 'JPG, PNG — สูงสุด 5MB' },
      transferDate: { en: 'Transfer date', th: 'วันที่โอน' },
      transferTime: { en: 'Time', th: 'เวลา' },
      fromBank: { en: 'From bank', th: 'ธนาคารต้นทาง' },
      fromBankPh: { en: 'e.g. SCB, Krungthai', th: 'เช่น SCB, กรุงไทย' },
      refNo: { en: 'Reference no. (optional)', th: 'เลขอ้างอิง (ถ้ามี)' },
      notes: { en: 'Notes (optional)', th: 'หมายเหตุ (optional)' },
      cancel: { en: 'Cancel', th: 'ยกเลิก' },
      submitSlip: { en: '📤 Submit Slip', th: '📤 ส่งสลิป' },
      amount: { en: '💰 Amount', th: '💰 จำนวนเงิน' },
      qrAuto: { en: '✅ Scan and the amount fills in automatically — no typing needed', th: '✅ สแกนแล้วยอดเงินขึ้นอัตโนมัติ — ไม่ต้องพิมพ์เอง' },
      qrScan: { en: 'Scan the QR to pay via PromptPay', th: 'สแกน QR เพื่อจ่ายด้วย PromptPay' },
      qrTypeAmount: { en: '⚠️ Please enter the amount ฿{amount} manually', th: '⚠️ กรุณาพิมพ์ยอด ฿{amount} เอง' },
      qrPlaceholder: { en: 'QR Code will appear here', th: 'QR Code จะปรากฏที่นี่' },
      qrNotSet: { en: '(School has not set up PromptPay yet)', th: '(โรงเรียนยังไม่ได้ตั้งค่า PromptPay)' },
      orBank: { en: '🏦 Or transfer via bank', th: '🏦 หรือโอนผ่านธนาคาร' },
      bank: { en: 'Bank', th: 'ธนาคาร' },
      accountNo: { en: 'Account no.', th: 'เลขบัญชี' },
      accountName: { en: 'Account name', th: 'ชื่อบัญชี' },
      branch: { en: 'Branch', th: 'สาขา' },
      uploading: { en: '⏳ Uploading...', th: '⏳ กำลังอัปโหลด...' },
      saving: { en: '💾 Saving...', th: '💾 บันทึก...' },
      toastFileBig: { en: '❌ File exceeds 5MB', th: '❌ ไฟล์ใหญ่เกิน 5MB' },
      toastChooseSlip: { en: '❌ Please select a slip image', th: '❌ กรุณาเลือกรูปสลิป' },
      toastSlipSent: { en: '✅ Slip submitted! Staff will verify shortly', th: '✅ ส่งสลิปสำเร็จ! ครูจะตรวจสอบให้เร็วๆ นี้' }
    },
    dashboard: {
